  ...
  return (
    <Card border="light" className="text-center p-0 mb-4">
      ...
      <Card.Body className="pb-5">
        <Card.Img src={props.userData.profile_image} alt="Neil Portrait" className="user-avatar large-avatar rounded-circle mx-auto mt-n7 mb-4" />
        <Card.Title>{`${props.credentials.user.first_name} ${props.credentials.user.last_name}`}</Card.Title>
        <Card.Subtitle className="fw-normal mb-1">{props.userData.designation}</Card.Subtitle>
...
export const ChoosePhotoWidget = (props) => {
  const { title, changeProfileImage } = props;
  return (
          ...
          <div className="file-field">
            <div className="d-flex justify-content-xl-center ms-xl-3">
              <div className="d-flex">
                ...
                <input type="file" onChange ={changeProfileImage} accept="image/*" />
